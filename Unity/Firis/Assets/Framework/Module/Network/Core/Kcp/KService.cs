...
namespace Firis
{
    ...
    public class KService : AService
    {
        ...
        public uint TimeNow
        {
            get
            {
                return (uint)(ClientNow() - this.startTime);
            }
        }
        ...
        public KService(MainThreadSynchronizationContext threadSynchronizationContext, IPEndPoint ipEndPoint)
        {
            this.ThreadSynchronizationContext = threadSynchronizationContext;
            this.startTime = ClientNow();
        ...
        public KService(MainThreadSynchronizationContext threadSynchronizationContext)
        {
            this.ThreadSynchronizationContext = threadSynchronizationContext;
            this.startTime = ClientNow();
            this.socket = new Socket(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
                        ...
                        case KcpProtocalType.SYN: // accept
                            {
                                ...
                                if (messageLength > 9)
                                {
                                    realAddress = System.Text.Encoding.Default.GetString(cache, 9, messageLength - 9);
                                }
