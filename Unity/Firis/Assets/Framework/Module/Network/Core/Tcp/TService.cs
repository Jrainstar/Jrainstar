...
namespace Firis
{
    ...
    {
        private readonly ConcurrentDictionary<long, TChannel> idChannels = new ConcurrentDictionary<long, TChannel>();
        ...
        public int linkCount => idChannels.Count;

        public TService(MainThreadSynchronizationContext threadSynchronizationContext)
        {
            this.ThreadSynchronizationContext = threadSynchronizationContext;
        }

        public TService(MainThreadSynchronizationContext threadSynchronizationContext, IPEndPoint ipEndPoint)
        {
            this.ThreadSynchronizationContext = threadSynchronizationContext;
        ...
        private void OnAcceptComplete(SocketError socketError, Socket acceptSocket)
        {
            ...
            try
            {
                ...
                this.idChannels.TryAdd(channel.Id, channel);
        ...
        public override void Remove(long id)
        {
            ...
            this.idChannels.Remove(id,out TChannel _);
        }
