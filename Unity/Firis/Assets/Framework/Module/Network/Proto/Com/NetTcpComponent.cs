...
namespace Firis
{
    public class NetTcpComponent : Component, IAwake<IMessageDispatcher>, IAwake<IPEndPoint, IMessageDispatcher>, IUpdate
    {
        ...
        public void Awake(IMessageDispatcher messageDispatcher)
        {
            ...
            Service = new TService(MainThreadSynchronizationContext.Instance);
        ...
        {
            MessageDispatcher = messageDispatcher;
            Service = new TService(MainThreadSynchronizationContext.Instance, endPoint);
            Service.ErrorCallback += (channelId, error) => OnError(channelId, error);
            Service.ReadCallback += (channelId, Memory) => OnRead(channelId, Memory);
