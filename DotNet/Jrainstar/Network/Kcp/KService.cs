...
namespace Jrainstar
{
    ...
    public sealed class KService : AService
    {
        ...
        public uint TimeNow
        {
            get
            {
                return (uint)(TimeComponent.Instance.ClientFrameTime() - this.startTime);
            }
        }
        ...
        public KService(IPEndPoint ipEndPoint, NetworkProtocol protocol, ServiceType serviceType)
        {
            ...
            this.startTime = TimeComponent.Instance.ClientFrameTime();
                ...
                try
                {
                    ...
                    switch (flag)
                    {
                        ...
                        case KcpProtocalType.RouterReconnectACK:
                            {
                                Console.WriteLine("RouterReconnectACK");
                        ...
                        case KcpProtocalType.RouterReconnectSYN:
                            {
                                Console.WriteLine("RouterReconnectSYN");
                        ...
                        case KcpProtocalType.SYN: // accept
                            {
                                ...
                                if (kChannel == null)
                                {
                                    ...
                                    kChannel = new KChannel(id, localConn, remoteConn, this.ipEndPoint.Clone(), this);
        ...
        {
            KChannel channel;
            this.localConnChannels.TryGetValue((uint)id, out channel);
            return channel;
        }
        ...
        public override void Create(long id, string address)
        {
            ...
            try
            {
                ...
                kChannel = new KChannel(id, localConn, endPoint, this);
                this.localConnChannels.Add(kChannel.LocalConn, kChannel);
            }
            catch (Exception e)
            {
