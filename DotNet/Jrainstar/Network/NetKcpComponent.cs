...
namespace Jrainstar
{
    ...
    public class NetKcpComponent : Component, IAwake<IPEndPoint, NetworkProtocol>, IAwake<AddressFamily, NetworkProtocol>, IUpdate
    {
        ...
        {
            AService = new KService(addressFamily, protocol, ServiceType.Outer);
        ...
        public void Awake(IPEndPoint address, NetworkProtocol protocol)
        {
            ...
            AService = new KService(address, protocol, ServiceType.Outer);
