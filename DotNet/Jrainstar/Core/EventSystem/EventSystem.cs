...
namespace Jrainstar
{
    ...
    public class EventSystem
    {
        ...
        private static ConcurrentDictionary<int, IEvent> events = new ConcurrentDictionary<int, IEvent>();

        #region 添加事件监听
        public static void AddEventListener(int name, Action action)
        {
        ...
        public static void AddEventListener<T>(int name, Action<T> action)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static void AddEventListener<T>(int name, Func<T> func)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static void AddEventListener<T, K>(int name, Func<T, K> func)
        {
            if (events.ContainsKey(name))
            {
        ...
        #region 移除事件监听
        public static void RemoveEventListener(int name, Action action)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static void RemoveEventListener<T>(int name, Action<T> action)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static void RemoveEventListener<T>(int name, Func<T> func)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static void RemoveEventListener<T, K>(int name, Func<T, K> func)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static void EventTrigger(int name)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static void EventTrigger<T>(int name, T info)
        {
            if (events.ContainsKey(name))
            {
        ...
        public static T EventTrigger<T>(int name)
        {
            T result = default;
            if (events.ContainsKey(name))
            {
        ...
        public static K EventTrigger<T, K>(int name, T info)
        {
            K result = default;
            if (events.ContainsKey(name))
            {
        ...
        #region 清空监听事件
        public static void ClearEventListener(int name)
        {
        ...
        public void Load(string assemblyName)
        {
            ...
            {
                BaseAttribute target = type.GetCustomAttribute<BaseAttribute>();
