...
namespace Firis
{
    ...
    public sealed class TChannel : AChannel
    {
        ...
        private readonly TPacket parser;

        private readonly byte[] sendCache = new byte[TPacket.PacketHeadLength];
        ...
        public TChannel(long id, IPEndPoint ipEndPoint, TService service)
        {
            ...
            this.parser = new TPacket(this.recvBuffer, this.sendBuffer);
